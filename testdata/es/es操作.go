...
func main() {
	...
	//Create(&DemoModel{Title: "java基础", UserID: 1, CreatedAt: time.Now().Format("2006-01-02 15:04:05")})
	/*	list, count := FindList("", 1, 10)
		fmt.Println(list, count)*/
	//FindSourceList("go", 1, 10)
	//Update("cN4yrYcBXzOyqPm6B_i1", &DemoModel{Title: "python入门"})
	//count, err := Remove([]string{"cN4yrYcBXzOyqPm6B_i1"})
